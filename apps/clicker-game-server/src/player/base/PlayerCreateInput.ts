...
class PlayerCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ClubCreateNestedManyWithoutPlayersInput,
  })
  @ValidateNested()
  @Type(() => ClubCreateNestedManyWithoutPlayersInput)
  @IsOptional()
  @Field(() => ClubCreateNestedManyWithoutPlayersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => FriendCreateNestedManyWithoutPlayersInput,
  })
  @ValidateNested()
  @Type(() => FriendCreateNestedManyWithoutPlayersInput)
  @IsOptional()
  @Field(() => FriendCreateNestedManyWithoutPlayersInput, {
    nullable: true,
  })
