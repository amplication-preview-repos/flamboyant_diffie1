...
export class UserControllerBase {
  ...
  @common.Get("/:id/clickEvents")
  @ApiNestedQuery(ClickEventFindManyArgs)
  async findClickEvents(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<ClickEvent[]> {
    const query = plainToClass(ClickEventFindManyArgs, request.query);
    const results = await this.service.findClickEvents(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/clickEvents")
  async connectClickEvents(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ClickEventWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      clickEvents: {
        connect: body,
  ...
  @common.Patch("/:id/clickEvents")
  async updateClickEvents(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ClickEventWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/clickEvents")
  async disconnectClickEvents(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ClickEventWhereUniqueInput[]
  ): Promise<void> {
    const data = {
